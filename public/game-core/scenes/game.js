...
class Game extends Phaser.Scene {
    ...
    //    this.puck = new Puck(this, this.gameFrame.frameX + this.gameFrame.frameWidth / 2, this.gameFrame.frameY + this.gameFrame.frameHeight / 2, 'puck');
       ...
       this.puck = this.physics.add.sprite( this.gameFrame.frameX + this.gameFrame.frameWidth / 2, this.gameFrame.frameY + this.gameFrame.frameHeight / 2, "puck").setDisplaySize(50 , 50);
