export default class ScoreManager {
  ...
  createHUD() {
    ...
    this.scoreTop = this.scene.add.text(0, -55, this.getScoreText().p1, {
      fontFamily: 'Impact',
      fontSize: '30px',
      color: '#615d8c',
      align: 'center',
    ...
    this.scoreBottom =  this.scene.add.text(0, 55, this.getScoreText().p2, {
      fontFamily: 'Impact',
      fontSize: '30px',
      color: '#615d8c',
      align: 'center',
    ...
    this.container = this.scene.add.container(width / 2, height / 2 , [ this.scoreBottom , this.scoreTop]);
